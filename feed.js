...
(function () {
  ...
  function injectStyles() {
    ...
    var css = ''
      ...
      + '.wf-carousel{display:flex;gap:var(--wf-gap);overflow-x:auto;scroll-snap-type:x proximity;-webkit-overflow-scrolling:touch;overscroll-behavior-x:contain;touch-action:pan-y;}'
